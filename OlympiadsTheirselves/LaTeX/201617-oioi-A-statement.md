...
Розглянемо 9-поверховий житловий будинок, в якому кілька під'їздів,
і кожен поверх кожного під'їзду містить рівно 4 квартири. Таким чином,
1-й поверх 1-го під'їзду містить квартири № 1, 2, 3, 4;
2-й поверх 1-го під'їзду --- квартири № 5, 6, 7, 8...;
9-й поверх 1-го під'їзду --- квартири № 33, 34, 35, 36;
1-й поверх 2-го під'їзду --- квартири № 37, 38, 39, 40,
і так далі.
...
`-` (мінус), `*` (множення), круглі дужки `(` та `)`
для групування та зміни порядку дій. Дозволяються пропуски (пробіли),
але, звісно, не всередині чисел і не всередині імен змінних.

Наприклад: можна здати вираз `pid * pov * kv` і отримати 26 балів з 200, бо він неправильний,
